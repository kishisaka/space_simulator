...
{	
  ...
  {
	    //set center target
	    MovementEngine currentMovementEngine = GameState._weapons.elementAt(_selected);
	    double centerX = (int)currentMovementEngine.getX();
	    double centerY = (int)currentMovementEngine.getY();
	
	    //clear radar (black)
	    g.setColor(new Color(0,0,0));
	    g.fillRect(0,0,_screenSize,_screenSize);
	
	    //draw center target (selected, white)
	    ...
	    for (int i = 0; i < GameState._weapons.size(); i ++)
	    {
	    	if (i != _selected)
	    	{	
		        currentMovementEngine = (MovementEngine)GameState._weapons.elementAt(i);
		        
		        double x = GameUtils.getA(centerX, currentMovementEngine.getX())/_scale;
		        double y = GameUtils.getB(centerY, currentMovementEngine.getY())/_scale;
		        ...
		        g.drawString(currentMovementEngine.getWeaponName(), (int)(250 + x) , (int)(250 - y - 10));
		        
		        if (currentMovementEngine.getWeaponName().equals("enemy"))
		        {
		        	g.setColor(new Color(252, 48, 0));
		        ...
		        else if(currentMovementEngine.getWeaponName().equals("gun_enemy"))
		        {		        	
		        	g.setColor(new Color(249,171,128));
		            // g.fillRect((int)(_screenSize/2 + x), (int)(_screenSize/2 - y), 3, 3);
		        }
		        else if(currentMovementEngine.getWeaponName().equals("gun_player"))
		        {
		        	g.setColor(new Color(0,255,0));
		            // g.fillRect((int)(_screenSize/2 + x), (int)(_screenSize/2 - y), 3, 3);
		        }
		        else if(currentMovementEngine.getWeaponName().equals("missile_player"))
		        {
		        	g.setColor(new Color(212,245,163));
		            // g.fillRect((int)(_screenSize/2 + x), (int)(_screenSize/2 - y), 3, 3);
		        	// g.drawImage(GameUtils.getImageType(currentMovementEngine.getCurrentDirection(), "missile"),(int)(232 + x), (int)(232 - y), null);
		        }
		        else if(currentMovementEngine.getWeaponName().equals("missile_enemy"))
		        {
		        	g.setColor(new Color(0,172,200));
		            // g.fillRect((int)(_screenSize/2 + x), (int)(_screenSize/2 - y), 3, 3);
		        	// g.drawImage(GameUtils.getImageType(currentMovementEngine.getCurrentDirection(), "missile"),(int)(232 + x), (int)(232 - y), null);
		        }
		        else if(currentMovementEngine.getWeaponName().equals("cloud"))
		        {		        
		        	// g.drawImage(GameUtils.getImageType(currentMovementEngine.getCurrentDirection(), "cloud"),(int)(((_screenSize/2) - 15) + x), (int)(((_screenSize/2)-15) - y), null);
		        }
		        else if(currentMovementEngine.getWeaponName().equals("explosion_particle"))
		        {		        
		        	g.setColor(new Color(115,134,230));
		            //g.fillRect((int)(_screenSize/2 + x), (int)(_screenSize/2 - y), 3, 3);
		        }
		        
		        //draw the ship. gun, missle, etc
		        g.fillRect((int)(_screenSize/2 + x), (int)(_screenSize/2 - y), 3, 3);
		        g.drawString(currentMovementEngine.getWeaponName(), (int)(250 + x) , (int)(250 - y - 10));
	    	}	
	    }
	    g.setColor(new Color(252,196,163));
	    g.drawString("x coord: " + (int)GameState._weapons.get(0).getX(), (int)(50) , (int)(450));
	    g.drawString("y coord: " + (int)GameState._weapons.get(0).getY(), (int)(150) , (int)(450));
	    g.drawString("speed: " + (int)GameState._weapons.get(0).getCurrentSpeed(), (int)(250) , (int)(450));
	    g.drawString("shields: " + GameState._weapons.get(0).getShields(), (int)(350) , (int)(450));	    
  ...
  public void changeTarget()
  {
	...
	public void keyPressed(KeyEvent arg0)
	{
		...
		if (keypress == 'a')
		{		
			GameState.mIsPlayerFireing = true;
		}
	}
	...
	public void keyReleased(KeyEvent arg0)
	{
		...
		if (keypress == 'a')
		{		
			GameState.mIsPlayerFireing = false;
		}
